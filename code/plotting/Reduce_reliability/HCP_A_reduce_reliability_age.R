...
outdir <- '/data/project/ukb_reliability_in_prediction/text_files/rel/'
beh <- 'interview_age'
...
tab <- read.csv('/data/project/ukb_reliability_in_prediction/text_files/HCP_A_age.csv')
...
#d = d[d[,beh] >= (mean(d[,beh]) - 3*sd(d[,beh])),]
# remove 100 year old outlier subs
d = d[d[,beh] < 1200,]
