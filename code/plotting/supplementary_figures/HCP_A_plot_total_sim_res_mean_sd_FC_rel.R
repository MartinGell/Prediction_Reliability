...
f = 'ridgeCV_zscore_averaged-source_Schaefer400x17_WM+CSF+GS_rest1_hcpaging_695_zscored-beh_HCP_A_total_wnoise_all.csv'
d_age_rest1 = read_csv(paste0(plt_in,f))

f = 'ridgeCV_zscore_averaged-source_Schaefer400x17_WM+CSF+GS_r2z2r_rest1AP_hcpaging_695_zscored-beh_HCP_A_total_wnoise_all.csv'
...
df_sum$reliability = df_sum$reliability * df_sum$reliability * 0.9
...
ggsave(paste0(plt_out,'rel_squared_total_R2_mean_sd_wnoise_rel_',rel_max,'_to_',rel_min,'_FC_rel.png'), pltm, width=5.5, height=3)
